      ...
      projects: [
        {
          ...
          image: "dist/images/project-moxies.jpg",
        ...
        },
        {
          ...
          image: "dist/images/project-local510.jpg",
        ...
        },
        {
          ...
          technologies: ["Drupal", "SASS", "JS", "Grunt", "Figma/Sketch"],
          image: "dist/images/project-spredfast.jpg",
        ...
        },
        {
          ...
          image: "dist/images/project-chop.jpg",
          url: "https://chop.ca"
        },
        {
          title: "Boulevard",
          description:
            "Full theme build for Boulevard Vancouver's website as part of the Simple Simple Ads development team. 2016.",
          technologies: ["Drupal", "SASS", "JS", "Gulp"],
          image: "dist/images/project-boulevard.jpg",
          url: "https://boulevardvancouver.ca"
        },
        {
          title: "Save Playlists",
          description:
            "Personal learning project. React app to save auto-generated Spotify playlists.",
          technologies: ["React", "SASS", "Babel", "Spotify API"],
          image: "dist/images/project-save-playlists.jpg",
          url: "https://www.save-playlists.com"
        },
        {
          title: "PWLS",
          description:
            "Personal learning project. React app for our bookclub. For scheduling meetups and suggesting books.",
          technologies: ["React", "SASS", "Babel", "Google Books API", "Firebase"],
          image: "dist/images/project-pwls.jpg",
          url: "https://prestigeworldwideliterary.herokuapp.com/"
        }
      ]
    };
  }
